...
part of 'support_web_service.dart';
...
class _SupportWebService implements SupportWebService {
  _SupportWebService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<NetworkBaseModel<List<SupportModel>>> getSupport(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NetworkBaseModel<List<SupportModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NetworkBaseModel<List<SupportModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<SupportModel>(
                  (i) => SupportModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
