...
part of 'corporate_web_service.dart';
...
class _CorporateWebService implements CorporateWebService {
  _CorporateWebService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<NetworkBaseModel<List<CorporateOrderModel>>> getCorporateOrders(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NetworkBaseModel<List<CorporateOrderModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NetworkBaseModel<List<CorporateOrderModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<CorporateOrderModel>((i) =>
                  CorporateOrderModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
  ...
  Future<NetworkBaseModel<CorporateOrderModel>> addCorporateOrder(
    ...
    final value = NetworkBaseModel<CorporateOrderModel>.fromJson(
      _result.data!,
      (json) => CorporateOrderModel.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
