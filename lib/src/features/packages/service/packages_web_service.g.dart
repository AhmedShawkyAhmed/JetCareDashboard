...
part of 'packages_web_service.dart';
...
class _PackagesWebService implements PackagesWebService {
  _PackagesWebService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<NetworkBaseModel<List<PackageModel>>> getAllPackages(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NetworkBaseModel<List<PackageModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NetworkBaseModel<List<PackageModel>>.fromJson(
      _result.data!,
  ...
  Future<NetworkBaseModel<PackageDetailsModel>> getPackageDetails(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NetworkBaseModel<PackageDetailsModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NetworkBaseModel<PackageDetailsModel>.fromJson(
      _result.data!,
      (json) => PackageDetailsModel.fromJson(json as Map<String, dynamic>),
    );
    return value;
  }
  ...
  Future<NetworkBaseModel<PackageModel>> addPackage({
    ...
    final value = NetworkBaseModel<PackageModel>.fromJson(
      _result.data!,
  ...
  @override
  Future<NetworkBaseModel<dynamic>> updatePackage({
