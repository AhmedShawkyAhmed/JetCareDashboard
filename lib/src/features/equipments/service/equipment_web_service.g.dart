...
part of 'equipment_web_service.dart';
...
class _EquipmentWebService implements EquipmentWebService {
  _EquipmentWebService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<NetworkBaseModel<List<EquipmentModel>>> getEquipment(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NetworkBaseModel<List<EquipmentModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NetworkBaseModel<List<EquipmentModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<EquipmentModel>(
                  (i) => EquipmentModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
  ...
  Future<NetworkBaseModel<EquipmentModel>> addEquipment({
    ...
    final value = NetworkBaseModel<EquipmentModel>.fromJson(
      _result.data!,
