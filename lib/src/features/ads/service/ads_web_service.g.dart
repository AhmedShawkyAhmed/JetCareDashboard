...
class _AdsWebService implements AdsWebService {
  _AdsWebService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<NetworkBaseModel<List<AdsModel>>> getAds({String? keyword}) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<NetworkBaseModel<List<AdsModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = NetworkBaseModel<List<AdsModel>>.fromJson(
      _result.data!,
  ...
  Future<NetworkBaseModel<AdsModel>> addAds({
    ...
    final value = NetworkBaseModel<AdsModel>.fromJson(
      _result.data!,
  ...
  @override
  Future<NetworkBaseModel<dynamic>> updateAds({
    AdsRequest? request,
    File? image,
  }) async {
    final _extra = <String, dynamic>{};
