...
class EndDrawerWidgetNotification extends StatelessWidget {
  EndDrawerWidgetNotification({super.key, 
    this.endDrawerWidth,
        ...
        return BackdropFilter(
          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: Padding(
                padding: EdgeInsets.only(bottom: 55.h, left: 1.w,top: 3.h),
                child: Column(
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize:fontTitle ?? 5.sp),
                        ),
                      ],
                    ),
                    Padding(
