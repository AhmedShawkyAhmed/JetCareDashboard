...
class CorporateItemsDesktop extends StatefulWidget {
  ...
  @override
  State<CorporateItemsDesktop> createState() => _CorporateItemsDesktopState();
}

class _CorporateItemsDesktopState extends State<CorporateItemsDesktop> {
  ...
  Widget build(BuildContext context) {
    var corporateItemCubit = CorporateItemCubit.get(context);
    return Scaffold(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    DefaultTextField(
                      ...
                      onChange: (value) {
                        if (value == "") {
                          corporateItemCubit.getItems(type: "corporate");
                        }
                      },
                      suffix: IconButton(
                        ...
                        onPressed: () {
                          corporateItemCubit
                              .getItems(keyword: search.text, type: "corporate");
                                ...
                                child: ListBody(
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child:
                                      BlocBuilder<CorporateItemCubit, CorporateItemState>(
              ...
              BlocBuilder<CorporateItemCubit, CorporateItemState>(
                builder: (context, state) {
                  if (corporateItemCubit.itemsResponse?.itemsModel ==
                      null) {
                    return SizedBox(
                      height: 79.h,
                  ...
                  return SizedBox(
                    height: 88.h,
                    child: ListView.builder(
                      itemCount: corporateItemCubit.listCount,
                      itemBuilder: (context, index) => Padding(
                        padding: EdgeInsets.only(
                          top: 2.h,
                          left: 3.2.w,
                        ...
                        child: RowData(
                          ...
                          data: [
                            ...
                            SizedBox(
                              height: 2.5.h,
                              child: CircleAvatar(
                                backgroundColor: corporateItemCubit
                                    .itemList[index]
                                    .active ==
                                    1
                                    ? AppColors.green
                            ...
                            Switch(
                                ...
                                splashRadius: 3.0,
                                onChanged: (value) {
                                  corporateItemCubit.switched(index);
                                  corporateItemCubit.updateItemsStatus(
                                    index: index,
                                    itemsRequest: ItemsRequest(
                                      id: corporateItemCubit
                                          .itemList[index]
                                          .id,
                                      active: corporateItemCubit
                                          .itemList[index]
                                          .active!
                                          .isOdd
                                          ? 1
                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  nameEn.text = corporateItemCubit
                                      ...
                                      .nameEn ??
                                      "";
                                  descriptionEn.text = corporateItemCubit
                                      .itemList[index]
                                      .descriptionEn ??
                                      "";
                                  nameAr.text = corporateItemCubit
                                      .itemList[index]
                                      .nameAr ??
                                      "";
                                  descriptionAr.text = corporateItemCubit
                                      .itemList[index]
                                      .descriptionAr ??
                                      "";
                                  unit.text = corporateItemCubit
                                      .itemList[index]
                                      .unit ??
                                      "";
                                  price.text = corporateItemCubit
                                      .itemList[index]
                                      .price
                                      .toString();
                                        ...
                                        child: ListBody(
                                          children: <Widget>[
                                            ...
                                            Padding(
                                              ...
                                              child: BlocBuilder<CorporateItemCubit,
                                                  CorporateItemState>(
                                                builder: (context, state) {
                                                  return Container(
                                                    height: 20.h,
                                                    ...
                                                    child: GlobalCubit.get(
                                                      ...
                                                      children: [
                                                        ClipRRect(
                                                          ...
                                                          child: imageItems ==
                                                              null
                                                              ? corporateItemCubit.fileResult ==
                                                              null
                                                              ? Container()
                                                              : Image
                                                              .memory(
                                                            corporateItemCubit.fileResult!.files.first.bytes!,
                                                            fit: BoxFit.fitWidth,
                                                            width: 100.w,
                                                          )
                                                              : Image
                                                        ...
                                                        Container(
                                                          ...
                                                          IconButton(
                                                            onPressed:
                                                              ...
                                                              imageItems =
                                                              null;
                                                              printSuccess(corporateItemCubit
                                                                  .fileResult
                                                                  .toString());
                                                            },
                                                            icon:
                            ...
                            IconButton(
                                onPressed: () {
                                  corporateItemCubit.deleteItems(
                                    itemsModel: corporateItemCubit
                                        .itemList[index],
                                  );
                                },
                                icon: const Icon(
