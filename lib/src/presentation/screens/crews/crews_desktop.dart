                              ...
                              child: RowData(
                                ...
                                data: [
                                  ...
                                  SizedBox(
                                    height: 2.5.h,
                                    child: CircleAvatar(
                                      backgroundColor: UsersCubit.get(context)
                                                  .userList[index]
                                                  .active ==
                                              1
                                          ? AppColors.green
                                  ...
                                  Switch(
                                    ...
                                    splashRadius: 3.0,
                                    onChanged: (value) {
                                      UsersCubit.get(context).switched(index);
                                      UsersCubit.get(context).updateUserStatus(
                                        indexs: index,
                                        userRequset: UserRequset(
                                          id: UsersCubit.get(context)
                                              .userList[index]
                                              .id,
                                          active: UsersCubit.get(context)
                                                  .userList[index]
                                                  .active
                                                  .isEven
                                              ? 0
